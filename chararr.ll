...
define internal fastcc void @Func_main(i32 %arg_esp) unnamed_addr #7 !retregs !12 {
  ...
  %2 = inttoptr i32 %tmp0_v.i.i to i32*
  store i32 %tmp2_v1.i.i, i32* %2, align 4
  %tmp2_v2.i.i = add i32 %arg_esp, -40
  %3 = inttoptr i32 %tmp2_v2.i.i to i32*
  store i32 134520840, i32* %3, align 4
  %tmp2_v3.i.i = add i32 %arg_esp, -36
  %4 = inttoptr i32 %tmp2_v3.i.i to i32*
  store i32 20, i32* %4, align 4
  %tmp2_v4.i.i = add i32 %arg_esp, -48
  %5 = inttoptr i32 %tmp2_v4.i.i to i32*
  store i32 134517171, i32* %5, align 4
  %arg.i.i = load i32, i32* %2, align 4
  %arg2.i.i = load i32, i32* %3, align 4
  %arg4.i.i = load i32, i32* %4, align 4
  %6 = inttoptr i32 %arg.i.i to i8*
  %7 = inttoptr i32 %arg2.i.i to i8*
  tail call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 1 %6, i8* align 1 %7, i32 %arg4.i.i, i1 false) #10
  %8 = load i16, i16* inttoptr (i32 134520860 to i16*), align 4
  %tmp2_v.i3.i = add i32 %arg_esp, -27
  %9 = inttoptr i32 %tmp2_v.i3.i to i16*
  store i16 %8, i16* %9, align 2
  %10 = load i8, i8* inttoptr (i32 134520862 to i8*), align 2
  %tmp2_v4.i4.i = add i32 %arg_esp, -25
  %11 = inttoptr i32 %tmp2_v4.i4.i to i8*
  store i8 %10, i8* %11, align 1
  %tmp2_v5.i.i = add i32 %arg_esp, -8
  %12 = inttoptr i32 %tmp2_v5.i.i to i32*
  %13 = load i32, i32* %12, align 4
  store i32 134520863, i32* %2, align 4
  store i32 %13, i32* %3, align 4
  store i32 134517210, i32* %5, align 4
  %14 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef 134520863, i32 inreg noundef 0, i32 noundef %tmp0_v.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32)) #11, !funcname !13
  %15 = lshr i64 %14, 32
  %16 = trunc i64 %15 to i32
  %17 = load i8, i8* %11, align 1
  %tmp0_v.i11.i = sext i8 %17 to i32
  store i32 134520872, i32* %2, align 4
  store i32 %tmp0_v.i11.i, i32* %3, align 4
  store i32 134517232, i32* %5, align 4
  %18 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef 134520872, i32 inreg noundef %16, i32 noundef %tmp0_v.i.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32)) #11, !funcname !13
  ret void
}
