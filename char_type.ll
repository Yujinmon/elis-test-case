...
define internal fastcc void @Func_main(i32 %arg_esp) unnamed_addr #7 !retregs !12 {
  ...
  %tmp0_v.i2.i = add i32 %arg_esp, -28
  %tmp2_v1.i.i = add i32 %arg_esp, -8
  %2 = inttoptr i32 %tmp2_v1.i.i to i32*
  store i32 0, i32* %2, align 4
  %tmp2_v2.i.i = add i32 %arg_esp, -9
  %3 = inttoptr i32 %tmp2_v2.i.i to i8*
  store i8 65, i8* %3, align 1
  %4 = inttoptr i32 %tmp0_v.i2.i to i32*
  store i32 134520840, i32* %4, align 4
  %tmp2_v5.i.i = add i32 %arg_esp, -24
  %5 = inttoptr i32 %tmp2_v5.i.i to i32*
  store i32 65, i32* %5, align 4
  %tmp2_v6.i.i = add i32 %arg_esp, -32
  %6 = inttoptr i32 %tmp2_v6.i.i to i32*
  store i32 134517159, i32* %6, align 4
  %7 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef 134520840, i32 inreg noundef 0, i32 noundef %tmp0_v.i2.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32)) #10, !funcname !13
  ret void
}
