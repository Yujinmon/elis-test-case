...
declare i32 @malloc(i32) local_unnamed_addr #7

; Function Attrs: noinline
declare void @free(i32) local_unnamed_addr #7

; Function Attrs: norecurse
define internal fastcc i32 @Func_main(i32 %arg_esp) unnamed_addr #8 !retregs !12 {
  %tmp2_v.i5.i = add i32 %arg_esp, -4
  %1 = inttoptr i32 %tmp2_v.i5.i to i32*
  store i32 0, i32* %1, align 4
  %tmp0_v.i7.i = add i32 %arg_esp, -44
  ...
  %4 = inttoptr i32 %tmp0_v.i7.i to i32*
  store i32 132, i32* %4, align 4
  %tmp2_v6.i.i = add i32 %arg_esp, -48
  %5 = inttoptr i32 %tmp2_v6.i.i to i32*
  store i32 134517186, i32* %5, align 4
  %arg.i.i = load i32, i32* %4, align 4
  %6 = tail call i32 @malloc(i32 %arg.i.i)
  %tmp2_v.i43.i = add i32 %arg_esp, -16
  %7 = inttoptr i32 %tmp2_v.i43.i to i32*
  store i32 %6, i32* %7, align 4
  %tmp2_v1.i44.i = add i32 %arg_esp, -20
  %8 = inttoptr i32 %tmp2_v1.i44.i to i32*
  store i32 0, i32* %8, align 4
  %9 = load i32, i32* %3, align 4
  %.not.i.i5 = icmp sgt i32 %9, 0
  br i1 %.not.i.i5, label %BB_80491D8.i, label %BB_80491F3.i

BB_8049204.i:                                     ; preds = %BB_80491F3.i, %BB_8049204.i
  %storemerge27 = phi i32 [ 0, %BB_80491F3.i ], [ %tmp0_v1.i.i, %BB_8049204.i ]
  %10 = load i32, i32* %7, align 4
  %tmp4_v.i.i = shl i32 %storemerge27, 2
  %tmp2_v5.i.i = add i32 %10, %tmp4_v.i.i
  ...
  store i32 134517286, i32* %5, align 4
  %13 = tail call x86_fastcallcc i64 @helper_stub_trampoline(i32 inreg noundef %storemerge27, i32 inreg noundef 134520840, i32 noundef %tmp0_v.i7.i, i32 noundef ptrtoint (i32 (i8*, ...)* @printf to i32)) #11, !funcname !13
  %14 = load i32, i32* %16, align 4
  %tmp0_v1.i.i = add i32 %14, 1
  store i32 %tmp0_v1.i.i, i32* %16, align 4
  %15 = icmp sgt i32 %tmp0_v1.i.i, 6
  br i1 %15, label %.exit, label %BB_8049204.i

BB_80491F3.i:                                     ; preds = %BB_80491D8.i, %0
  %tmp2_v.i12.i = add i32 %arg_esp, -24
  %16 = inttoptr i32 %tmp2_v.i12.i to i32*
  %tmp2_v7.i.i = add i32 %arg_esp, -40
  %17 = inttoptr i32 %tmp2_v7.i.i to i32*
  %tmp2_v8.i.i = add i32 %arg_esp, -36
  %18 = inttoptr i32 %tmp2_v8.i.i to i32*
  store i32 0, i32* %16, align 4
  br label %BB_8049204.i

BB_80491D8.i:                                     ; preds = %BB_80491D8.i, %0
  %storemerge6 = phi i32 [ %tmp0_v6.i35.i, %BB_80491D8.i ], [ 0, %0 ]
  %19 = load i32, i32* %7, align 4
  %tmp4_v.i32.i = shl i32 %storemerge6, 2
  %tmp2_v3.i33.i = add i32 %19, %tmp4_v.i32.i
  %20 = inttoptr i32 %tmp2_v3.i33.i to i32*
  store i32 11, i32* %20, align 4
  %21 = load i32, i32* %8, align 4
  %tmp0_v6.i35.i = add i32 %21, 1
  store i32 %tmp0_v6.i35.i, i32* %8, align 4
  %22 = load i32, i32* %3, align 4
  %.not.i.i = icmp slt i32 %tmp0_v6.i35.i, %22
  br i1 %.not.i.i, label %BB_80491D8.i, label %BB_80491F3.i

.exit:                                            ; preds = %BB_8049204.i
  %23 = load i32, i32* %7, align 4
  store i32 %23, i32* %4, align 4
  store i32 134517311, i32* %5, align 4
  %arg.i.i4 = load i32, i32* %4, align 4
