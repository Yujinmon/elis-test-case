; ModuleID = '/home/yujin/elis/pass/output.ll'
...
define dso_local void @NOALIAS(i8* noundef %p, i8* noundef %q) #0 {
entry:
...
define dso_local void @MUSTALIAS(i8* noundef %p, i8* noundef %q) #0 {
entry:
  %p.addr = alloca i8*, align 8
  %q.addr = alloca i8*, align 8
  store i8* %p, i8** %p.addr, align 8
...
define internal fastcc void @Func_main(i32 %arg_esp) unnamed_addr #7 !retregs !12 {
  %xffffffb0 = alloca i32, align 4
  %xffffffb4 = alloca i32, align 4
  %xffffffd0 = alloca i32, align 4
  %xffffffe8 = alloca i32, align 4
  %xffffffec = alloca i32, align 4
  %xfffffff8 = alloca i32, align 4
  %xfffffffc = alloca i32, align 4
  %xffffffb8 = alloca i32*, align 4
  %xffffffbc = alloca i32*, align 4
  %xffffffcc = alloca i32*, align 4
  %xffffffd4 = alloca i32*, align 4
  %xffffffd8 = alloca i32*, align 4
  %xfffffff0 = alloca i32*, align 4
  %xfffffff4 = alloca i32*, align 4
  store i32 0, i32* %xfffffffc, align 4
  store i32 0, i32* %xfffffff8, align 4
  store volatile i32* %xffffffec, i32** %xfffffff4, align 4
  store volatile i32* %xffffffe8, i32** %xfffffff0, align 4
  store volatile i32* %xffffffec, i32** %xffffffd4, align 4
  store volatile i32* %xffffffe8, i32** %xffffffd8, align 4
  store i32 134517627, i32* %xffffffd0, align 4
  store volatile i32* %xfffffffc, i32** %xffffffcc, align 4
  store i32 134520902, i32* %xffffffb4, align 4
  store volatile i32* %xffffffec, i32** %xffffffb8, align 4
  store volatile i32* %xffffffe8, i32** %xffffffbc, align 4
  store i32 134517320, i32* %xffffffb0, align 4

  %arg1_ptr = load i32*, i32** %xffffffb8
  %bit_arg1 = bitcast i32* %arg1_ptr to i8*
  %arg2_ptr = load i32*, i32** %xffffffbc
  %bit_arg2 = bitcast i32* %arg2_ptr to i8*
  call void @NOALIAS(i8* %bit_arg1, i8* %bit_arg2)

  ; %1 = call i32 (i8*, ...) @printf(i8* inttoptr (i32 134520902 to i8*))
  %load6 = load i32*, i32** %xfffffff0, align 4
  store volatile i32* %load6, i32** %xfffffff4, align 4
  store volatile i32* %xffffffe8, i32** %xffffffd4, align 4
  store volatile i32* %xffffffe8, i32** %xffffffd8, align 4
  store i32 134517651, i32* %xffffffd0, align 4

  store volatile i32* %xfffffffc, i32** %xffffffcc, align 4
  store i32 134520840, i32* %xffffffb4, align 4
  store volatile i32* %xffffffe8, i32** %xffffffb8, align 4
  store volatile i32* %xffffffe8, i32** %xffffffbc, align 4
  store i32 134517176, i32* %xffffffb0, align 4

  %arg1_ptr_2 = load i32*, i32** %xffffffb8
  %bit_arg1_2 = bitcast i32* %arg1_ptr_2 to i8*
  %arg2_ptr_2 = load i32*, i32** %xffffffbc
  %bit_arg2_2 = bitcast i32* %arg2_ptr_2 to i8*
  call void @MUSTALIAS(i8* %bit_arg1_2, i8* %bit_arg2_2)
  ; %2 = call i32 (i8*, ...) @printf(i8* inttoptr (i32 134520840 to i8*))
  ret void
}
